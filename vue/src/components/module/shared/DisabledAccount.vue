            ...
            <div class="col-md-5 offset-md-1 col-sm-12 col-12">
              <div class="login-card">
                <div class="login-body">
                  ...
                  <div>
                    We're sorry! This account no longer exists. For further assistance,
                    Please contact us at contact@closefriend.io
                  </div>
                  ...
                  <!--                  <div class="form-group">
                                    ...
                                    <div class="form-group">
                                      &lt;!&ndash;                      <label for="email" class="font-grey">Email <span class="danger ml-2">You haven’t filled this field</span> </label>&ndash;&gt;
                  ...
                  &lt;!&ndash;                      <input type="checkbox" name="remember" class="custom-control-input" tabindex="3" id="remember-me">
                                        <label class="custom-control-label font-size-12" >By signing up you are agreeing&ndash;&gt;
